...
class DataApp(QMainWindow):
    ...
    def initUI(self):
        ...
        self.graph_type_combo.currentIndexChanged.connect(self.update_graph)  # Обновление графика при изменении типа
    ...
    def load_data(self):
        ...
        if file_path:
            ...
            self.display_stats()
            self.update_graph()
            # Вызов функции, чтобы сразу отобразить нужные поля для ввода
    ...
    def display_stats(self):
        if self.data is not None:
            ...
            stats = pd.DataFrame({
                ...
                "Стандартное отклонение": numeric_data.std()
            })
    ...
    def toggle_input_fields(self):
        ...
        # Скрываем или показываем поля в зависимости от типа графика
    ...
    def add_data(self):
        ...
        # Преобразуем столбец Date в datetime перед обновлением графика
